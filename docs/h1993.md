...
## Notes
Chop-chop, It's time to move on. Start with ansering **"Heston model"**, instead of the 60-years-old **Black-Scholes model**, when you are asked to name an option pricing model.
