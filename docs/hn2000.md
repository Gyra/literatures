...
## Notes
The model proposed by Heston and Nandi, denote as HN model in the following, is one of the most important discrete option pricing model.
Similar to Heston's another model, aka the **Heston model** in continuous setting, HN model has been the foundation of many more discrete model afterwards.
